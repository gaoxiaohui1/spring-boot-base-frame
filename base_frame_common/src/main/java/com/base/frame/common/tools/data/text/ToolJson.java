...
import com.base.frame.common.tools.data.decimal.Decimal;
import com.base.frame.common.tools.data.text.json.TypeBuilder;
import com.base.frame.common.tools.data.text.json.typeadapter.BigDecimalTypeAdapter;
import com.base.frame.common.tools.data.text.json.typeadapter.DatePlusTypeAdapter;
import com.base.frame.common.tools.data.text.json.typeadapter.DecimalTypeAdapter;
import com.base.frame.common.tools.data.text.json.typeadapter.LocalDateTimeTypeAdapter;
import com.base.frame.common.tools.data.text.json.typeadapter.LocalDateTypeAdapter;
import com.base.frame.common.tools.data.text.json.typeadapter.TreeMapTypeAdapter;
import com.base.frame.common.tools.time.DatePlus;
...
public final class ToolJson {
     ...
     * @return String
     */
    public final static <T> String modelToJson(T model) {
        if (model == null) {
            return "{}";
        }
     ...
     * @return Object
     */
    public final static <T> T jsonToModel(String sJson, Type type) {
     ...
     * @return Object
     */
    public final static <S, T> S anyToAny(T t, Type type) {
        String json;
     ...
     * @return Object
     */
    public final static <T> Map modelToMap(T data) {
     ...
     * @return Object
     */
    public final static <T> List<Map> modelToMapList(T data) {
     ...
     */
    public final static <T> ArrayList<T> jsonToArrayList(String json, Class<T> clazz) {
     ...
     */
    public final static ArrayList<String> jsonToArrayList(String json) {
        Type type = new TypeToken<ArrayList<JsonObject>>() {
        }.getType();
        ArrayList<JsonObject> jsonObjects = gson.fromJson(json, type);
     ...
     * @return List<String>
     */
    public final static List<String> dealJsonStr(String json) {
