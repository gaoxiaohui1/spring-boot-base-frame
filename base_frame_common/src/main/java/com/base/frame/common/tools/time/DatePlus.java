package com.base.frame.common.tools.time;
...
public class DatePlus implements Serializable, Cloneable {
    ...
    public DatePlus(long time) {
        this.localDateTime = com.base.frame.common.tools.time.ToolDatePlus.time2LocalDateTime(time);
    }

    public DatePlus(java.util.Date date) {
        this.localDateTime = com.base.frame.common.tools.time.ToolDatePlus.date2LocalDateTime(date);
    }

    public DatePlus(String dateStr, String pattern) {
        try {
            this.localDateTime = LocalDateTime.parse(dateStr, com.base.frame.common.tools.time.ToolDatePlus.pattern(pattern));
        } catch (DateTimeParseException e) {
            LocalDate date = LocalDate.parse(dateStr, com.base.frame.common.tools.time.ToolDatePlus.pattern(pattern));
    ...
    //region 属性的比较
    public boolean isBefore(DatePlus datePlus, com.base.frame.common.tools.time.DateType dateType) {
        boolean isBefore;
        switch (dateType) {
            case YEAR:
    ...
    public boolean isSame(DatePlus datePlus, com.base.frame.common.tools.time.DateType dateType) {
        boolean isSame;
        switch (dateType) {
            case YEAR:
    ...
    public boolean isAfter(DatePlus datePlus, com.base.frame.common.tools.time.DateType dateType) {
        boolean isAfter;
        switch (dateType) {
            case YEAR:
    ...
    public DatePlus toMinDate(com.base.frame.common.tools.time.DateType dateType) {
        switch (dateType) {
            case YEAR:
    ...
    public DatePlus toMaxDate(com.base.frame.common.tools.time.DateType dateType) {
        switch (dateType) {
            case YEAR:
    ...
    public Date toDate() {
        return com.base.frame.common.tools.time.ToolDatePlus.localDateTime2Date(this.localDateTime);
    }
    ...
    public String toGanZhi() {
        return com.base.frame.common.tools.time.ToolLunar.lunarYearToGanZhi(toLunar().getLunarYear());
    }
     ...
     * @return 阴历对象
     */
    public com.base.frame.common.tools.time.Lunar toLunar() {
        com.base.frame.common.tools.time.Solar solar = new com.base.frame.common.tools.time.Solar(this.getYear(), this.getMonth(), this.getDayOfMonth());
        return com.base.frame.common.tools.time.ToolLunar.solartolunar(solar);
    }
     ...
     * @return 公历对象
     */
    public com.base.frame.common.tools.time.Solar toSolar() {
        com.base.frame.common.tools.time.Lunar lunar = new com.base.frame.common.tools.time.Lunar(this.getYear(), this.getMonth(), this.getDayOfMonth());
        return com.base.frame.common.tools.time.ToolLunar.lunartosolar(lunar);
    }

    private static final DateTimeFormatter DEFAULT_DATE_TIME_FORMATTER = com.base.frame.common.tools.time.ToolDatePlus.pattern("yyyy-MM-dd HH:mm:ss:SSS");
    ...
    public String toString(String pattern) {
        return this.localDateTime.format(com.base.frame.common.tools.time.ToolDatePlus.pattern(pattern));
    }
