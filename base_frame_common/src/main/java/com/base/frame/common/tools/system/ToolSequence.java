...
public class ToolSequence {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ToolSequence.class);
     ...
     */
    public ToolSequence(long workerId, long datacenterId) throws Exception {
