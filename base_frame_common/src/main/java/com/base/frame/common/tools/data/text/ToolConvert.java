...
import com.base.frame.common.tools.constant.UnitConst;
...
public final class ToolConvert {
     ...
     * 获取obj的属性及其对应值map
     * @param obj
     * @param hasNull true-包含null值；false-不包含null值
     * @return
     */
    public static Map<String, Object> getKeyValueMap(Object obj, boolean hasNull ,boolean isLinkedHashMap) {
